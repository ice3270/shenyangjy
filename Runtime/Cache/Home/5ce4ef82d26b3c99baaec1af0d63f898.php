...
<head>
    <title>Blog | Repute Lite - Free Bootstrap Business Template</title>
    <meta charset="utf-8">
...
<body>
                ...
                <div id="main-nav" class="navbar-collapse collapse navbar-mega-menu">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li class="active"><a href="blog-medium-thumbnail.html">Blog Medium Thumbnail</a></li>
                                        ...
                                        <div class="col-sm-5">
                                            <figure class="featured-image">
                                                <a href="blog-single.html">
                                                    ...
                                                    <img src="/shenyangjy/Home/assets/img/blog/buildings-med.jpg" class="img-responsive" alt="featured-image" />
                                                </a>
                                            </figure>
                                        </div>
                                        <div class="col-sm-7">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-5">
                                            <figure class="featured-image">
                                                <a href="blog-single.html">
                                                    <div class="post-date-info clearfix"><span class="post-month">NOV</span><span class="post-date">28</span><span class="post-year">2014</span></div>
                                                    <img src="/shenyangjy/Home/assets/img/blog/people-med.jpg" class="img-responsive" alt="featured-image" />
                                                </a>
                                            </figure>
                                        </div>
                                        <div class="col-sm-7">
    ...
    <script src="/shenyangjy/Home/assets/js/plugins/fitvids/jquery.fitvids.js"></script>
