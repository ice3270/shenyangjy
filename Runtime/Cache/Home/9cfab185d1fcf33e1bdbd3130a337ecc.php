...
<head>
    <title>Contact Us | Repute Lite - Free Bootstrap Business Template</title>
    <meta charset="utf-8">
...
<body>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li class="active"><a href="page-contacts.html">Contact</a></li>
    ...
    <script src="/shenyangjy/Home/assets/js/plugins/google-map/google-map.js"></script>
