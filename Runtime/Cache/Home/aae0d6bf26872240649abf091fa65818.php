...
<head>
    <title>Portfolio | Repute Lite - Free Bootstrap Business Template</title>
    <meta charset="utf-8">
...
<body>
                ...
                <div id="main-nav" class="navbar-collapse collapse navbar-mega-menu">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li class="active"><a href="portfolio-4-columns.html">Portfolio 4 Columns</a></li>
                    ...
                    <ul class="portfolio-item-list portfolio-isotope portfolio-nospace list-col-4">
                        <li class="portfolio-item design">
                            ...
                            <div class="media-wrapper">
                                <img src="/shenyangjy/Home/assets/img/portfolio/800x800/work1.png" alt="This is the description">
                            </div>
                        </li>
                        <li class="portfolio-item ux">
                            ...
                            <div class="media-wrapper">
                                <img src="/shenyangjy/Home/assets/img/portfolio/800x800/work3.png" alt="Portfolio Thumbnail">
                            </div>
                        </li>
                        <li class="portfolio-item photography">
                            ...
                            <div class="media-wrapper">
                                <img src="/shenyangjy/Home/assets/img/portfolio/800x800/work4.png" alt="Portfolio Thumbnail">
                            </div>
                        </li>
                        <li class="portfolio-item photography ux">
                            ...
                            <div class="media-wrapper">
                                <img src="/shenyangjy/Home/assets/img/portfolio/800x800/work5.png" alt="Portfolio Thumbnail">
                            </div>
                        </li>
                        <li class="portfolio-item photography ui">
                            ...
                            <div class="media-wrapper">
                                <img src="/shenyangjy/Home/assets/img/portfolio/800x800/work6.png" alt="Portfolio Thumbnail">
                            </div>
                        </li>
                        <li class="portfolio-item photography">
                            <div class="overlay"></div>
                            ...
                            <div class="media-wrapper">
                                <img src="/shenyangjy/Home/assets/img/portfolio/800x800/work7.png" alt="Portfolio Thumbnail">
                            </div>
                        </li>
                        <li class="portfolio-item photography">
                            <div class="overlay"></div>
                            ...
                            <div class="media-wrapper">
                                <img src="/shenyangjy/Home/assets/img/portfolio/800x800/work8.png" alt="Portfolio Thumbnail">
                            </div>
                        </li>
    ...
    <script src="/shenyangjy/Home/assets/js/plugins/isotope/isotope.pkgd.js"></script>
