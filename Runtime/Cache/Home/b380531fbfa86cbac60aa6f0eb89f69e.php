...
<head>
    <title>Blog Single Item | Repute Lite - Free Bootstrap Business Template</title>
    <meta charset="utf-8">
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a href="index.html" class="navbar-brand navbar-logo">
                        <img src="/shenyangjy/Home/assets/img/logo/repute-logo-nav.png" alt="Repute Lite - Free Bootstrap Business Template">
                    </a>
                </div>
                <!-- MAIN NAVIGATION -->
                        ...
                        <div class="blog single full-thumbnail">
                            ...
                            <article class="entry-post">
                                ...
                                <div class="entry-content clearfix">
                                    <figure class="featured-image">
                                        ...
                                        <img src="/shenyangjy/Home/assets/img/blog/buildings.jpg" class="img-responsive" alt="featured-image" />
                                    </figure>
                                    <div class="excerpt">
                            ...
                            <section class="author-info">
                                ...
                                <div class="media">
                                    <a href="#" class="media-left">
                                        <img src="/shenyangjy/Home/assets/img/user2.png" class="img-circle" alt="Avatar">
                                    </a>
                            ...
                            <section>
                                ...
                                <ul class="list-unstyled related-post-list row">
                                    <li class="col-md-4">
                                        <a href="#">
                                            <img src="/shenyangjy/Home/assets/img/blog/people-med.jpg" class="img-responsive" alt="Related Post">
                                        </a>
                                        <a href="#" class="post-title">Monotonectally Pursue Extensive Process iImprovements</a>
                                    </li>
                                    <li class="col-md-4">
                                        <a href="#">
                                            <img src="/shenyangjy/Home/assets/img/blog/buildings-med.jpg" class="img-responsive" alt="Related Post">
                                        </a>
                                        <a href="#" class="post-title">Progressively Maximize Multidisciplinary Innovation Before Proactive E-markets</a>
                                    </li>
                                    <li class="col-md-4">
                                        <a href="#">
                                            <img src="/shenyangjy/Home/assets/img/blog/balloon-med.jpg" class="img-responsive" alt="Related Post">
                                        </a>
                            ...
                            <article class="comments">
                                ...
                                <ul class="media-list">
                                    <li class="media">
                                        <a href="#" class="media-left">
                                            <img src="/shenyangjy/Home/assets/img/user1.png" class="avatar" alt="avatar">
                                        </a>
                                        <div class="media-body">
                                            ...
                                            <div class="media comment-by-author">
                                                <a href="#" class="media-left">
                                                    <img src="/shenyangjy/Home/assets/img/user2.png" class="avatar" alt="avatar">
                                                </a>
                                                <div class="media-body">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="content-recent-comments" class="tab-pane fade" role="tabpanel">
                                        <ul class="list-unstyled recent-comments">
                                            <li>
                                                <div class="media">
                                                    <a href="#" class="media-left"><img src="/shenyangjy/Home/assets/img/user1.png" class="img-circle" alt="Avatar"></a>
                                                    <div class="media-body">
                                            ...
                                            <li>
                                                <div class="media">
                                                    <a href="#" class="media-left"><img src="/shenyangjy/Home/assets/img/user2.png" class="img-circle" alt="Avatar"></a>
                                                    <div class="media-body">
                                            ...
                                            <li>
                                                <div class="media">
                                                    <a href="#" class="media-left"><img src="/shenyangjy/Home/assets/img/user3.png" class="img-circle" alt="Avatar"></a>
                                                    <div class="media-body">
                                            ...
                                            <li>
                                                <div class="media">
                                                    <a href="#" class="media-left"><img src="/shenyangjy/Home/assets/img/user4.png" class="img-circle" alt="Avatar"></a>
                                                    <div class="media-body">
                                            ...
                                            <li>
                                                <div class="media">
                                                    <a href="#" class="media-left"><img src="/shenyangjy/Home/assets/img/user5.png" class="img-circle" alt="Avatar"></a>
                                                    <div class="media-body">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <img src="/shenyangjy/Home/assets/img/logo/repute-logo-light.png" class="logo" alt="Repute">
